  ...
  main(int argc, char * argv[])
{
  ...
  if (rtmGetErrorStatus(S) == NULL) {
    ...
    fflush(stdout);
    result = hil_task_start(helicopter1_DW.HILReadEncoderTimebase_Task, (t_clock)
      helicopter1_P.HILReadEncoderTimebase_Clock, 500.0, -1)
      ;
    if (result == 0) {
