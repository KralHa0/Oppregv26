...
#ifndef RTW_HEADER_helicopter1_h_
#define RTW_HEADER_helicopter1_h_
#include <math.h>
#include <string.h>
#ifndef helicopter1_COMMON_INCLUDES_
#define helicopter1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter1_COMMON_INCLUDES_ */

#include "helicopter1_types.h"
...
#define helicopter1_rtModel            RT_MODEL_helicopter1_T
...
#define rtB                            helicopter1_B
#define BlockIO                        B_helicopter1_T
#define rtX                            helicopter1_X
#define ContinuousStates               X_helicopter1_T
#define rtXdot                         helicopter1_XDot
#define StateDerivatives               XDot_helicopter1_T
#define tXdis                          helicopter1_XDis
#define StateDisabled                  XDis_helicopter1_T
#define rtP                            helicopter1_P
#define Parameters                     P_helicopter1_T
#define rtDWork                        helicopter1_DW
#define D_Work                         DW_helicopter1_T

/* Parameters (default storage) */
struct P_helicopter1_T_ {
...
extern P_helicopter1_T helicopter1_P;

/* Block signals (default storage) */
extern B_helicopter1_T helicopter1_B;

/* Continuous states (default storage) */
extern X_helicopter1_T helicopter1_X;

/* Block states (default storage) */
extern DW_helicopter1_T helicopter1_DW;

/* Model entry point functions */
extern void helicopter1_initialize(void);
extern void helicopter1_output(void);
extern void helicopter1_update(void);
extern void helicopter1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter1_rtModel *helicopter1(void);
...
extern RT_MODEL_helicopter1_T *const helicopter1_M;
 ...
 *
 * '<Root>' : 'helicopter1'
 * '<S1>'   : 'helicopter1/Conversion'
 * '<S2>'   : 'helicopter1/Degrees to Radians'
 * '<S3>'   : 'helicopter1/Elevation controller'
 * '<S4>'   : 'helicopter1/Helicopter_interface'
 * '<S5>'   : 'helicopter1/LQR'
 * '<S6>'   : 'helicopter1/Pitch controller'
 * '<S7>'   : 'helicopter1/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'helicopter1/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter1/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter1/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter1/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter1/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter1/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter1/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter1_h_ */
