...
MODEL                = helicopter1
MODULES              = helicopter1_data.c helicopter1_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_sim.c
MAKEFILE             = helicopter1.mk
...
START_DIR            = C:\Users\harunc\Desktop\04.02.1016\Lab1
...
NCSTATES             = 4
COMPUTER             = PCWIN64
BUILDARGS            =  EXT_MODE=1 EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 SHOW_TIMES=0 DEBUG=0 DEBUG_HEAP=0 INCLUDE_MDL_TERMINATE_FCN=1 OPTS="-DEXT_MODE -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1"
MULTITASKING         = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = helicopter1_ref.rsp

COMPILER_COMMAND_FILE     = helicopter1_comp.rsp
